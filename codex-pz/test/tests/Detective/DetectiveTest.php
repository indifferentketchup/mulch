...
use IndifferentKetchup\CodexPz\Test\Src\Analysis\TestSolution;
use IndifferentKetchup\CodexPz\Test\Src\Log\TestAlwaysDetectableLog;
use IndifferentKetchup\CodexPz\Test\Src\Log\TestLessDetectableLog;
use IndifferentKetchup\CodexPz\Test\Src\Log\TestMoreDetectableLog;
use IndifferentKetchup\CodexPz\Test\Src\Log\TestNeverDetectableLog;
...
class DetectiveTest extends TestCase
{
    ...
    protected function getDetective(array $possibleLogClasses): Detective
    {
        ...
        $detective->setLogFile(new \IndifferentKetchup\CodexPz\Log\File\PathLogFile(__DIR__ . '/../../data/simple.log'));
