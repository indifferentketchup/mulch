...
* Analysis and parsing using [indifferentketchup/codex-pz](https://git.indifferentketchup.com/indifferentketchup/ik-codex-pz), forked from [aternos/codex-minecraft](https://github.com/aternosorg/codex-minecraft)
